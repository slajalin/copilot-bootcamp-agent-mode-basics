...
- [MUI Guidelines](../docs/mui-guidelines.md) - Material-UI component usage and styling guidelines
...
- Use Material-UI (MUI) components following the established guidelines for consistent UI design
